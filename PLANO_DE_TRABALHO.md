...
- [~] Varrer PRD, RFC, FDD e cada ADR extraindo os itens rastreáveis. (RFC, FDD e os 7 ADRs cobertos — 73 linhas; só falta o PRD, ainda placeholder na Fase 5)
- [~] Cobertura ≥80% dos itens identificáveis nos documentos. (100% dos itens identificáveis em RFC+FDD+ADRs hoje; métrica final só fecha depois que o PRD existir)
- [x] ≥70% das linhas com Fonte = `TRANSCRICAO` e timestamp válido no formato `[hh:mm] Nome`. (55/73 = ~75%)
